  ...
  render() {
    return (
      <div className={s.root}>
            ...
            >
              ...
              <div className="row progress-stats">
                <div className="col-md-9 col-12">
                  <h6 className="name fw-semi-bold">Government Tags</h6>
              ...
              <div className="row progress-stats">
                <div className="col-md-9 col-12">
                  <h6 className="name fw-semi-bold">Conversation Flagged</h6>
                  <p className="description deemphasize mb-xs text-white">
                    P. to C. Conversion
                  </p>
                  <Progress
              ...
              <div className="row progress-stats">
                <div className="col-md-9 col-12">
                  <h6 className="name fw-semi-bold">Sound Frequencies Captured</h6>
                  <p className="description deemphasize mb-xs text-white">
                    Average Bitrate
                  </p>
                  <Progress
        ...
        <Row>
          <Col lg={6} xl={4} xs={12}>
            <Widget title={<h6> GOVERNENT TAGS</h6>} close settings>
              <div className="stats-row">
                <div className="stat-item">
                  <h6 className="name">Devolution Confrence</h6>
          ...
          <Col lg={6} xl={4} xs={12}>
            <Widget title={<h6> ARP POISONING </h6>} close settings>
              <div className="stats-row">
                <div className="stat-item">
                  <h6 className="name">Overall MITM Done!
                  </h6>
                  <p className="value">17 567 318</p>
                </div>
                <div className="stat-item">
                  <h6 className="name">Must Go</h6>
                  <p className="value">55 120</p>
                </div>
                <div className="stat-item">
                  <h6 className="name">Kumi Tena</h6>
          ...
          <Col lg={6} xl={4} xs={12}>
            <Widget title={<h6> DEVICE FINGERPRINTING </h6>} close settings>
              <div className="stats-row">
                <div className="stat-item">
        ...
        <Row>
          <Col lg={4} xs={12}>
            <Widget
              title={
                <h6>
                  <span className="badge badge-success mr-2">New</span> Messages Tracked
                </h6>
              }
              refresh
              close
              ...
              <div className="widget-body undo_padding">
                <div className="list-group list-group-lg">
                  <button className="list-group-item text-left">
                    ...
                    <div>
                      <h6 className="m-0">Suspect 1</h6>
                      <p className="help-block text-ellipsis m-0">
                        We are going to attack statehouse.
                      </p>
                    </div>
                  </button>
                  <button className="list-group-item text-left">
                  ...
                  <button className="list-group-item text-left">
                    ...
                    <div>
                      ...
                      <p className="help-block text-ellipsis m-0">
                        I have sponsered the protest and Goons.
                      </p>
                    </div>
                  </button>
                  <button className="list-group-item text-left">
          ...
          <Col lg={4} xs={12}>
            <Widget
              title={
                <h6>
                  {" "}
                  Sound <span className="fw-semi-bold">Frequencies</span>
                </h6>
              }
              close
            >
              <div className="widget-body">
                ...
                <p className="fs-mini text-muted mb mt-sm">
                  Target <span className="fw-semi-bold">820</span> Hertz
                  is <span className="fw-semi-bold">96%</span> clear.
                </p>
              </div>
                ...
                <Table striped size="sm">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>John Doe</td>
                      <td className="text-align-right fw-semi-bold">...</td>
                    </tr>
                    <tr>
                      <td>
                        <div className="checkbox abc-checkbox">
