...
const Typography = () => (
  <div>
    <h1 className="page-title">
      Man-in-the-Middle - <span className="fw-semi-bold">Capture, Monitor, Log</span>
    </h1>
    <Row>
      <Col xs={12} lg={6}>
        <Widget
        ...
        >
          ...
          <div className="widget-padding-md w-100 h-100 text-left border rounded">
            <Row>
              ...
              <Col sm={6}>
                <h1 className="text-danger">Spending transparent</h1>
                <h2 className="text-warning">Kumi Tena</h2>
                <h3 className="text-lime">Tujenge Nchi</h3>
              </Col>
            </Row>
          </div>
          <h4 className="mt-5">Telegram Chat</h4>
      ...
      <Col xs={12} lg={6}>
        <Widget
          title={
            <h5>
              Whatsapp <small className="text-muted">Monitoring</small>
            </h5>
          }
          close
          collapse
        >
          <h4>Offensive Text</h4>
          <p>Text to Monitor</p>
          <div className="widget-padding-md w-100 h-100 text-left border rounded">
            <p>
            The national budget is publicly available, with spending tracked by the <mark>National Treasury and Auditor-General</mark> reports. Always check official records before believing such claims.
            </p>
            <p>
              <del>
              The government is giving free 10GB internet bundles to everyone this week.
              </del>
            </p>
            <p>
              <ins>
